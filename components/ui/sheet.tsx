...
const SheetOverlay = ({ ref, className, ...props }: ComponentProps<typeof SheetPrimitive.Overlay>) => (
...
const SheetTitle = ({ ref, className, ...props }: ComponentProps<typeof SheetPrimitive.Title>) => (
    <SheetPrimitive.Title ref={ref} className={cn('text-lg font-semibold text-foreground', className)} {...props} />
)
SheetTitle.displayName = SheetPrimitive.Title.displayName

const SheetDescription = ({ ref, className, ...props }: ComponentProps<typeof SheetPrimitive.Description>) => (
