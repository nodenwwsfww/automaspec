...
const ContextMenuContent = ({ ref, className, ...props }: ComponentProps<typeof ContextMenuPrimitive.Content>) => (
...
const ContextMenuSeparator = ({ ref, className, ...props }: ComponentProps<typeof ContextMenuPrimitive.Separator>) => (
