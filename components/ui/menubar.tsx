...
const Menubar = ({ ref, className, ...props }: ComponentProps<typeof MenubarPrimitive.Root>) => (
...
const MenubarTrigger = ({ ref, className, ...props }: ComponentProps<typeof MenubarPrimitive.Trigger>) => (
...
const MenubarSubContent = ({ ref, className, ...props }: ComponentProps<typeof MenubarPrimitive.SubContent>) => (
...
const MenubarSeparator = ({ ref, className, ...props }: ComponentProps<typeof MenubarPrimitive.Separator>) => (
