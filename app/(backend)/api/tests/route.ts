...
export async function POST(request: NextRequest) {
  try {
    ...
    switch (type) {
      case 'category':
        result = await db.insert(testCategories).values({
        ...
        break
      case 'group':
        result = await db.insert(testGroup).values({
          id: crypto.randomUUID(),
          ...data,
          createdAt: new Date(),
          updatedAt: new Date(),
        ...
        break
      case 'test':
        result = await db.insert(test).values({
          id: crypto.randomUUID(),
          ...data,
          createdAt: new Date(),
          updatedAt: new Date(),
        ...
        break
      case 'requirement':
        result = await db.insert(testRequirement).values({
          id: crypto.randomUUID(),
          ...data,
          createdAt: new Date(),
          updatedAt: new Date(),
